...
class LoginGo(object):
    ...
    URL_QINIU = 'http://qinum-file.xxxxxxx.com'
    ...
    def login_cw(mobile, pwd):
        ...
        headers = {'author': 'xxxxxxx.com', 'authorization': 'null', "channel": "cw"}
    ...
    def login_crm(mobile, pwd, channel):
        userName = {"mobile": mobile, "channel": channel, "password": pwd}
        headers = {'author': 'xxxxxxx.com', 'authorization': 'null', "channel": channel}
